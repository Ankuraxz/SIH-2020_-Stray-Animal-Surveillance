...
path = ".././Test images/test3.jpg"
loc ="29.965109,76.875464" # predefined location here
cam_name = "cam3" #predefined cam name
loc_link = "https://www.google.com/maps/place/29%C2%B057'54.4%22N+76%C2%B052'31.7%22E/@29.965109,76.8732753,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0x0!8m2!3d29.965109!4d76.875464"
...
def sms(tag,prob,loc,loc_,date,time,cam,to_tx):
    ...
    for _ in range (len(tag)):
        tag1 = str(tag[_])
        prob1 = str(prob[_])
        msg = "Animal"+tag1+"is detected in "+ cam +" with a confidence of"+prob1 +"at location"+loc+"on"+ date +"at"+ time +" Location link:" +loc_
